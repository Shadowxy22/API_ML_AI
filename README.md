...
## 价值主张设计
**一句话版本**
本产品旨在通过调用腾讯云中的人脸识别、人脸融合、人脸试妆、图像分析等api技术实现口红的试用及购买的功能，用户可以挑选感兴趣的口红，线上就能实现试用效果。

**一分钟版本**
经调查显示，现如今有许多美颜相机能换妆添加滤镜甚至变脸的效果，但并没有成型的对口红可以试色及购买的app。这款app主打将试色功能与购物相结合，主要运用腾讯云中人脸识别、人脸融合、人脸试妆、图像分析等api技术，用户挑选感兴趣的口红，打开摄像头呈现口红在脸上的效果，可选择性进行购买。还有一些明星或者网红的口红色号，用户能通过上传该明星或网红的照片，推荐出同款口红。
### 一、背景
经调查显示，现如今有许多美颜相机能换妆添加滤镜甚至变脸的效果，假若能有一款产品可以将现有的美妆产品购物app的与美颜相机相结合，用户挑选感兴趣的口红，打开摄像头呈现口红在脸上的效果，用户可选择性进行购买。还有一些明星或者网红的口红色号，用户能通过上传该明星或网红的照片，推荐出同款口红。

PRD1.加值宣言 3%
### （一）加值宣言
本产品旨在通过调用腾讯云中的人脸识别、人脸融合、人脸试妆、图像分析等api技术实现美妆产品的试用及购买的功能，用户可以挑选感兴趣的口红产品，线上就能实现试用效果，并给用户推荐挑选出更合适的口红。用户也能通过上传照片，系统通过图像分析技术，识别出相似口红色号，推荐出相似口红。
